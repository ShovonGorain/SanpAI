...
class VideoProcessor:
    def __init__(self, upload_folder):
        ...
        self.effects = ['blur', 'contrast', 'black_white', 'sepia', 'vignette', 'sharpen', 'solarize', 'invert', 'grayscale']
        self.transitions = [
            'fade',
            'slide_in',
            'slide_out',
        ...
        try:
            ...
            if audio_clip:
                try:
                    ...
                    # Set audio without altering the tune.
                    # If the audio is longer than the video, it will be automatically trimmed to the video's duration upon writing.
